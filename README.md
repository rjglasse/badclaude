...
| `go` 📍 *you are here* | 🐹 Go | Go 1.21+ | ...like small languages, fast builds and `if err != nil` |
| `python` | 🐍 Python | Python 3.9+ | ...want the least code between you and a working agent |
